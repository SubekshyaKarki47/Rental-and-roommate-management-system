...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'roommatehub-insecure-dev-key-change-in-prod-!829#a')
...
# Fallback seamlessly to SQLite if PostgreSQL connection is not specified or fails
DB_ENGINE = os.getenv('DB_ENGINE', 'sqlite3')
if DB_ENGINE == 'postgres' or DB_ENGINE == 'postgresql':
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('DB_NAME', 'roommatehub'),
